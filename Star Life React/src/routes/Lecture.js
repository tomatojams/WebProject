        ...
        <RowContainer>
          ...
          <TextContainer>
            ...
            <p>
              ...
              <br />
              <br /> 색종이, 한지 ,골판지, 습자지등을 매체로 미술수업할 수 있는 노인종이조형 심리
              미술지도사 자격증입니다. <br />
              <strong>미술치료이론을 배우고 실습</strong>을 통해 심리미술치료를 알아가는 과정.
              노인종이조형미술수업은 어르신들의 인지 및 감각 운동 기능을 향상 시키고, 무엇보다{" "}
              <strong>자존감을 높여 주어</strong>서 삶의 의미나 목적까지도 제공해줄 수 있는 수업.
            </p>
        ...
        <RowContainer>
          <TextContainer>
            ...
            <p>
              ...
              토탈공예에서는 클레이,레진공예,냅킨공예, 캔들공예, 지끈공예, 가죽공예,
              비즈공예,미니어쳐, 우드공예 등 배울 수 있다.
            </p>
            <StyledButtonLink to="/board" state={{ fromLecture: true }}>
              강의 신청
            </StyledButtonLink>
        ...
        <RowContainer>
          ...
          <TextContainer>
            ...
            <p>
              ...
              상담과 다양한 치료기법을 통해<strong>자기이해와 자기수용능력을 향상</strong> 시켜
