...
var genericPrint = function (arr) {
    arr.forEach(function (i) { return console.log(i); });
};
genericPrint([1, 2, 3, 4]);
genericPrint([1, "a", true, 0.1]);
var genericPrint2 = function (arr) { return arr[0]; };
// 5. generic vs any
