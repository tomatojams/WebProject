...
if (player.age && player.age < 10) {} //4. 매개변수에도 타입지정 가능,
...
jams.age = 12; //6.  리턴타입 명시 -> 함수 자체에 타입명시하는것과 같음
...
jams2.age = 12; //7. 상수형 함수 타입지정, 매개변수 뒤에:

var playerMaker3 = function playerMaker3(name) {
  return {
    name: name
  };
};